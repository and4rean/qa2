...
public class MainDelfiTestOld {
    ...
    public void delfiTestASOLD() throws InterruptedException {
        ...
        */
        ...
        for (WebElement tit : titles)        { System.out.println(tit.getText() + " -index- " + titles.indexOf(tit)); }
        //for (WebElement c : counts) { System.out.println(c.getText()); }


        System.out.println();
        System.out.println(" -= mobileTitles! =- -> " + mobileTitles.size()); System.out.println("=============================");
        for (WebElement mobTit : mobileTitles) { System.out.println(mobTit.getText()  + " -index- " + mobileTitles.indexOf(mobTit)); }
